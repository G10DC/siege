...
`siege` is an agent skill for **authorized** penetration testing, CTFs, and security
...
Copy into `~/.gemini/config/skills/siege/`. Agent environment auto-loads any folder that contains a `SKILL.md`.
